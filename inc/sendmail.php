...
function sendLevelUpdate($aid, $sid, $site) {
  ...
  $leve_up = getLevelup($status['status'], $u['fname'], $u['points'], $nextLevel['status'], $points_needed, $dashboard);
