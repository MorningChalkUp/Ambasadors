...
function sendInvite($to, $type, $amb) {
  ...
  if ($type == 'amb') {
    $copy = '<p>I want you to become a Morning Chalk Up Ambassador!</p><p>Join me and <a href="http://ambassadors.morningchalkup.com/join/?reff=' . $amb->getValue('username') . '">sign up here</a>!</p>';
    $subject = 'Join Me As A Morning Chalk Up Ambassadors';
  } elseif ($type == 'sub') {
    $copy = '<p>Cheack out the Morning Chalk Up!</p><p>You can <a href="http://ambassadors.morningchalkup.com/subscribe/?reff=' . $amb->getValue('username') . '">sign up here</a>!</p>';
